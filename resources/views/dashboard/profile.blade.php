...
@section('container')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4 py-5 px-3">
            <h1 class="h3 mb-4 text-gray-800 fw-bold text-center">Profil</h1>
            <div class="mx-auto d-block">
                <img src="{{ asset('storage/' . $user->foto) }}" class="rounded" width="250" height="250">
            </div>
            <form action="/dashboard/profile/{{ $user->id }}" method="POST" class="px-4"
                ...
                <div class="mb-3">
                    ...
                    <input hidden type="text" class="form-control form-control-sm @error('role') is-invalid @enderror"
