...
@section('container')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800 fw-bold">Surat Keluar</h1>
