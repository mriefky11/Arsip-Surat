            ...
            <form action="/dashboard/disposisi/" method="POST" class="px-4">
                ...
                <div class="mb-3">
                    ...
                    <input hidden type="text"
                        ...
                        value="{{ old('id_pengirim', $suratMasuk->pengirim_id) }}">
                    {{-- @error('pengirim_id')
                ...
                <div class="mb-3">
                    {{-- <label for="pengirim" class="form-label">Nama Pengirim</label> --}}
                    <input hidden type="text"
                        class="form-control form-control-sm @error('id_penerima') is-invalid @enderror" name="id_penerima"
                        id="id_penerima" placeholder="" autofocus required
                        value="{{ old('id_penerima', Auth()->user()->id) }}">
                    {{-- @error('pengirim_id')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm @error('nomor_surat') is-invalid @enderror"
                        name="nomor_surat" id="nomor_surat" placeholder="" autofocus
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('tanggal_dikirim', $suratMasuk->created_at) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm @error('pengirim') is-invalid @enderror"
                        name="pengirim" id="pengirim" placeholder="" autofocus
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm @error('diterima_oleh') is-invalid @enderror"
                        name="diterima_oleh" id="diterima_oleh" placeholder="" autofocus required
                        value="{{ old('diterima_oleh') }}">
                    @error('diterima_oleh')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-5">
                    ...
                    <input id="x" type="hidden" name="isi_disposisi" value="{{ old('isi_disposisi') }}"required
                        autofocus>
                    @error('isi_disposisi')
                        <p>{{ $message }}</p>
                    @enderror
