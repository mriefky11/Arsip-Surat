...
@section('container')
    <div class="container-fluid">
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800 fw-bold">Edit Disposisi Surat</h1>

        {{-- form control --}}

        <div class="card shadow mb-4 py-5 px-3">
            <form action="/dashboard/disposisi/{{ $Disposisi->id }}" method="POST" class="px-4">
                @method('put')
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm @error('nomor_surat') is-invalid @enderror"
                        ...
                        value="{{ old('nomor_surat', $Disposisi->nomor_surat) }}">
                    @error('nomor_surat')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm @error('pengirim') is-invalid @enderror"
                        ...
                        value="{{ old('pengirim', $Disposisi->pengirim) }}">
                    @error('pengirim')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
