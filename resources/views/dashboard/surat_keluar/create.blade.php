...
@section('container')
    <div class="container-fluid">
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800 fw-bold">Kirim Surat</h1>

        {{-- form control --}}
        <div class="card shadow mb-4 py-5 px-3">
            <form action="/dashboard/surat_keluar/" method="POST" class="px-4" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input hidden type="text"
                        class="form-control form-control-sm @error('pengirim_id') is-invalid @enderror" name="pengirim_id"
                        id="pengirim_id" placeholder="" autofocus required
                        value="{{ old('pengirim_id', Auth()->user()->id) }}">
                    {{-- @error('pengirim_id')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm @error('pengirim') is-invalid @enderror"
                        ...
                        value="{{ old('pengirim', Auth()->user()->nama) }}">
                    @error('pengirim')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm @error('tembusan') is-invalid @enderror"
                        name="tembusan" id="tembusan" placeholder="" autofocus value="{{ old('tembusan') }}">
                    @error('tembusan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input multiple type="file" class="form-control @error('file_pdf') is-invalid @enderror"
                        id="file_pdf" name="file_pdf" autofocus value="{{ old('file_pdf') }}">
                    @error('file_pdf')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-5">
                    ...
                    <input id="x" type="hidden" name="perihal" value="{{ old('perihal') }}"required autofocus>
                    @error('perihal')
                        <p>{{ $message }}</p>
                    @enderror
